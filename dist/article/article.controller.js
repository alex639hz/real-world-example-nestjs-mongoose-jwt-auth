...
__decorate([
    ...
    swagger_1.ApiOperation({ title: 'Get All article', }),
...
__decorate([
    common_1.Get(':id'),
    common_1.HttpCode(common_1.HttpStatus.OK),
    swagger_1.ApiOperation({ title: 'Get One article', }),
    swagger_1.ApiImplicitParam({ name: 'id', description: 'id of article' }),
    swagger_1.ApiOkResponse({}),
...
__decorate([
    ...
    swagger_1.ApiOperation({ title: 'Create one article', }),
...
__decorate([
    ...
    common_1.UseGuards(passport_1.AuthGuard('jwt')),
    roles_decorator_1.Roles('admin'),
    swagger_1.ApiOperation({ title: 'Update one article by id ( all params )', }),
    swagger_1.ApiBearerAuth(),
    swagger_1.ApiImplicitParam({ name: 'id', description: 'id of article' }),
    swagger_1.ApiImplicitHeader({
        name: 'Bearer',
...
__decorate([
    ...
    common_1.UseGuards(passport_1.AuthGuard('jwt')),
    roles_decorator_1.Roles('admin'),
    swagger_1.ApiOperation({ title: 'Delete one article', }),
    swagger_1.ApiBearerAuth(),
    swagger_1.ApiImplicitHeader({
        name: 'Bearer',
        description: 'the token we need for auth.'
    }),
    swagger_1.ApiImplicitParam({ name: 'id', description: 'id of article we want to delete.' }),
    swagger_1.ApiOkResponse({}),
    __param(0, common_1.Param()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
